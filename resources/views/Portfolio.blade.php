...
<main x-data="{ activeTab: 'brochure' }" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10 mb-32 mt-16">
    ...
    <div class="flex flex-wrap justify-center gap-3 sm:gap-4 pb-4 mt-8">
        <button @click="activeTab = 'logo'"
            :class="activeTab==='logo' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
        ...
        <button @click="activeTab = 'brochure'"
            :class="activeTab==='brochure' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            Brochure Design
        </button>

        <button @click="activeTab = 'flyer'"
            :class="activeTab==='flyer' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            Flyer
        </button>

        <button @click="activeTab = 'business'"
            :class="activeTab==='business' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            Business Card
        </button>

        <button @click="activeTab = 'idcard'"
            :class="activeTab==='idcard' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            ID Card
        </button>

        <button @click="activeTab = 'poster'"
            :class="activeTab==='poster' ? 'bg-[#E04794] text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            Poster Print
        </button>

        <button @click="activeTab = 'video'"
            :class="activeTab==='video' ? 'bg-[#E04794]500 text-white border-pink-500' : 'bg-white text-gray-800 border-[#E0E0E0] hover:bg-[#FCEDF4]'"
            class="px-5 py-2.5 rounded-sm border text-sm font-medium font-heading shadow-[0_1px_3px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.06)]">
            Video Promotion
        </button>
    </div>
