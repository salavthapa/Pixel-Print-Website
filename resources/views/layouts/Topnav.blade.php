<!-- Top Header -->
<div class="bg-[#2A143C] text-white text-sm">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-6 py-2 md:space-y-0">
        ...
        <div class="flex items-center space-x-2 mt-2 md:mt-0">
            <a href="#" class="p-1 border rounded-full hover:bg-yellow-500 hover:text-black m-0 w-[29px] text-center"><i
                    class="fa-brands fa-facebook"></i></a>
            <a href="#" class="p-1 border rounded-full hover:bg-yellow-500 hover:text-black w-[29px] text-center"><i
