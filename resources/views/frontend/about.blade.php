    ...
    <section id="team" class="relative -mt-10 mb-40">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 -mt-32 sm:-mt-16 md:-mt-16 lg:-mt-44">
            ...
            <div class="relative mt-6">
                <!-- Controls -->
                <button id="sliderPrev" aria-label="Previous"
                    class="absolute left-2 md:-left-2 top-1/2 -translate-y-1/2 z-10
           ...
           grid place-items-center hover:bg-white">
                ...
                <button id="sliderNext" aria-label="Next"
                    class="absolute right-2 md:-right-2 top-1/2 -translate-y-1/2 z-10
